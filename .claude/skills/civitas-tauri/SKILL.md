---
name: civitas-tauri
description: Add or change Tauri commands and TypeScript bindings in the civitas desktop app. Use when editing #[tauri::command] handlers, lib/utils/tauri.ts, or Rust types exported to the frontend.
---

# Civitas Tauri (desktop app)

Path: `apps/civitas-app-tauri/`
