...
-- This is one-time and idempotent. A sanitized 70k-chunk production-scale
-- database completes it in under a second; cost scales linearly with chunk
-- count, not transcript count.
UPDATE audio_chunks
