...
--
-- Diagnosed from a privacy-sanitized customer report on v2.4.39: meeting
-- transcripts collapsed to a single "you" speaker because the cosine-distance
-- lookup timed out and the diarization pipeline fell back to the
-- calendar-default user. Six consecutive sqlx warnings exceeded 60 seconds on
-- the same query.
--
