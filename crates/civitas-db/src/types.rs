...
pub enum SearchResult {
    ...
    /// Persistent memory
    Memory(MemoryRecord),
    /// User-selected project-root file evidence
    ProjectFile(ProjectFileResult),
}
...
pub enum ContentType {
    ...
    Memory,
    /// Selected project-root files and metadata
    #[serde(alias = "project_file", alias = "projectFile", alias = "file")]
    ProjectFile,
}
...
pub struct MemoryRecord {
    ...
    // ── work-graph typed columns (migration 20260620000002) ──
    /// Embedding pipeline state: 'pending' | 'in_progress' | 'done' | 'failed'.
    /// INERT in PR#1 (always 'pending'); the embedding worker lands in PR#2.
    #[serde(default = "default_embedding_status")]
    pub embedding_status: String,
    /// Soft confidence counter — NEVER an admission gate. Starts at 1 on write.
    #[serde(default = "default_occurrences")]
    pub occurrences: i64,
    /// Grounding evidence JSON: {"steps":[...], "source_action_ids":[...]}.
    #[serde(default)]
    pub evidence: Option<String>,
    /// Actor that produced this memory (local user identifier, or NULL).
    #[serde(default)]
    pub actor: Option<String>,
    /// Visibility scope: 'personal' | 'team' | 'org'. PR#1 always 'personal'.
    #[serde(default = "default_scope")]
    pub scope: String,
    /// LLM model that produced the note (e.g. the Scribe model), or NULL.
    #[serde(default)]
    pub model_version: Option<String>,
    /// Redaction pass identifier applied before storage, or NULL.
    #[serde(default)]
    pub redaction_version: Option<String>,
    /// JSON array of semantic_actions.id values that grounded this memory.
    #[serde(default)]
...
pub struct ProjectFileRecord {
    ...
    pub relative_path_folded: String,
    pub safe_display_path: String,
    pub name: String,
    ...
    pub cjk_search_text: Option<String>,
    pub status: String,
...
#[derive(OaSchema, Debug, Serialize, Deserialize, FromRow, Clone, Default)]
#[serde(rename_all = "camelCase")]
pub struct ProjectRootCapabilitySummary {
...
pub struct ReviewCandidateRecord {
    pub id: i64,
    pub candidate_id: String,
    pub asset_type: String,
    pub title: String,
    pub summary: String,
    pub structured_fields: String,
    pub explicit_vs_inferred_labels: String,
    pub evidence_list: String,
    pub local_evidence_pointers: String,
...
#[derive(Debug, Clone)]
pub struct ReviewCandidateUpsert {
    pub candidate_id: String,
    pub asset_type: String,
    pub title: String,
    pub summary: String,
...
pub struct ReviewCandidatePatch {
    pub title: Option<String>,
    pub summary: Option<String>,
    pub structured_fields: Option<String>,
    pub explicit_vs_inferred_labels: Option<String>,
    pub redacted_preview: Option<String>,
    pub privacy_scope: Option<String>,
    pub risk_tier: Option<String>,
    pub sensitivity_flags: Option<String>,
    pub deterministic_metadata: Option<String>,
...
mod tests {
    ...
    fn test_content_type_deserialization() {
        ...
        assert_eq!(
            ...
            serde_json::from_str(r#""project_file""#).unwrap()
        );
        assert_eq!(
            ContentType::ProjectFile,
