...
static DEF: IntegrationDef = IntegrationDef {
    ...
    description: "Bee wearable AI — captures in-person conversations, facts, todos, and daily summaries. Pair with civitas to cover what you saw on screen plus what you heard out loud. Get a developer token from the Bee iOS app (tap version 5x to enable Developer Mode).",
    fields: &[FieldDef {
        key: "api_key",
...
mod tests {
    ...
    ///
    ///   cargo test -p civitas-connect connections::bee::tests::live_api_smoke \
    ///     -- --ignored --nocapture
    ///
