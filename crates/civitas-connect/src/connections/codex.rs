...
static DEF: IntegrationDef = IntegrationDef {
    ...
    description: "Continuously sync civitas memories into the OpenAI Codex CLI's memory store (CODEX_HOME/AGENTS.md by default). Civitas writes a marker block that it owns and rewrites idempotently — hand-edited content outside the block is left alone. Leave home_path empty to use the default ($CODEX_HOME or ~/.codex).",
    fields: &[FieldDef {
        key: "home_path",
...
/// Codex CLI itself does so civitas writes to the same place the
