...
//!
//! End-to-end benchmarks for the civitas audio pipeline, measuring:
...
//! cargo test -p civitas-audio --test audio_pipeline_benchmark vad_threshold_sweep_synthetic -- --nocapture
//!
