...
//! The actual UI-scanning detection logic lives in `civitas-engine::meeting_detector`.
...
async fn replay_scenario(
    ...
    // Track meeting state based on events (simulating what civitas-engine does)
