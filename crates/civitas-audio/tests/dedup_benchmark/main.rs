...
//! ```bash
//! # Run all benchmarks
//! cargo test --package civitas-audio --test dedup_benchmark -- --nocapture
//!
//! # Run specific scenario
//! cargo test --package civitas-audio --test dedup_benchmark continuous_24h -- --nocapture
//!
//! # Run with release optimizations (for timing accuracy)
//! cargo test --release --package civitas-audio --test dedup_benchmark -- --nocapture
//! ```
//!
//! ## Metrics
//!
