...
/// Chunk duration in seconds (matches civitas default)
pub const CHUNK_DURATION_SECS: f64 = 10.0;

/// Overlap between chunks in seconds (matches civitas default)
...
impl RecordingSession {
    ...
    /// Generate simulated audio chunks as they would be produced by civitas
...
use civitas_audio::transcription::text_utils::longest_common_word_substring;
