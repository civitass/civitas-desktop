...
pub enum Language {
    ...
    #[clap(name = "chinese")]
    Chinese,
    #[clap(name = "chinese-simplified")]
    ChineseSimplified,
    #[clap(name = "chinese-traditional")]
    ChineseTraditional,
    #[clap(name = "german")]
    German,
    #[clap(name = "spanish")]
...
impl Language {
    pub fn as_lang_code(&self) -> &'static str {
        match self {
            Language::English => "en",
            Language::Chinese => "zh",
            // Speech providers generally expose one Mandarin/Chinese code. OCR
            // adapters preserve the script distinction with their own BCP-47 or
            // traineddata mappings.
...
impl std::str::FromStr for Language {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s.to_lowercase().as_str() {
            ...
            "chinese-simplified" | "simplified-chinese" | "zh-hans" | "zh_cn" | "zh-cn"
            | "chi_sim" => Ok(Self::ChineseSimplified),
            "chinese-traditional"
            | "traditional-chinese"
            | "zh-hant"
            | "zh_tw"
            | "zh-tw"
            | "chi_tra" => Ok(Self::ChineseTraditional),
...
pub const TESSERACT_LANGUAGES: [(&str, &str); 78] = [
    ("eng", "english"),
    ("chi_sim", "chinese"),
