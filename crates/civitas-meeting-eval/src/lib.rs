...
//!
//! Drives the prod state machine (`civitas_engine::meeting_detector::advance_state`)
//! against scripted scan traces and computes precision/recall/flap metrics.
//!
//! # Why this exists
//!
//! Meeting detection has accumulated many edge-case fixes
...
//! A synthetic Active⇌Ending browser-toolbar flap is
...
use civitas_engine::meeting_detector::{advance_state, MeetingState, ScanResult, StateAction};
...
mod tests {
    ...
    /// own flap accounting matches the synthetic regression shape.
    /// When the hysteresis fix
