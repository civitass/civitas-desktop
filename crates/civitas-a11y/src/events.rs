...
//! Based on bigbrother's event format with extensions for civitas integration.
...
impl UiEvent {
    ...
    pub fn to_db_insert(&self, session_id: Option<String>) -> civitas_db::InsertUiEvent {
        use civitas_db::{InsertUiEvent, UiEventType};
