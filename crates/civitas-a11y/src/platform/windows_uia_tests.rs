...
/// Run with: cargo test -p civitas-a11y test_notepad_tree_structure -- --nocapture --ignored
#[test]
#[ignore]
...
/// Run with: cargo test -p civitas-a11y test_notepad_text_capture -- --nocapture --ignored
#[test]
#[ignore]
fn test_notepad_text_capture() {
    ...
    let test_text = "Hello civitas accessibility test 12345";
...
/// Run with: cargo test -p civitas-a11y test_calculator_tree_structure -- --nocapture --ignored
#[test]
#[ignore]
...
/// Run with: cargo test -p civitas-a11y test_multi_app_tree_isolation -- --nocapture --ignored
#[test]
#[ignore]
...
/// Run with: cargo test -p civitas-a11y test_full_pipeline_with_app -- --nocapture --ignored
#[test]
#[ignore]
...
/// Run with: cargo test -p civitas-a11y test_focusable_state_capture -- --nocapture --ignored
#[test]
#[ignore]
...
/// Run with: cargo test -p civitas-a11y test_real_app_capture_perf -- --nocapture --ignored
#[test]
#[ignore]
...
/// Run with: cargo test -p civitas-a11y test_memory_footprint -- --nocapture --ignored
#[test]
#[ignore]
...
/// Run with: cargo test -p civitas-a11y test_memory_stability -- --nocapture --ignored
#[test]
#[ignore]
...
/// Run with: cargo test -p civitas-a11y test_calculator_completeness -- --nocapture --ignored
#[test]
#[ignore]
...
/// Run with: cargo test -p civitas-a11y test_capture_consistency -- --nocapture --ignored
#[test]
#[ignore]
...
/// Run with: cargo test -p civitas-a11y test_serialization_fidelity -- --nocapture --ignored
#[test]
#[ignore]
