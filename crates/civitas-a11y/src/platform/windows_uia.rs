...
fn pause_uia_while_screen_locked(
    ...
    if !civitas_config::screen_is_locked() {
        return false;
    }
...
mod tests {
    ...
    /// Run with: cargo test --package civitas-accessibility test_live_all_windows -- --nocapture --ignored
    #[test]
    #[ignore]
    ...
    /// Run with: cargo test --package civitas-accessibility test_live_tree_capture -- --nocapture --ignored
    #[test]
    #[ignore]
    ...
    /// Run with: cargo test --package civitas-accessibility test_live_performance -- --nocapture --ignored
    #[test]
    #[ignore]
    ...
    /// Run with: cargo test --package civitas-accessibility test_live_dedup -- --nocapture --ignored
    #[test]
    #[ignore]
    fn test_live_dedup() {
        unsafe {
    ...
    /// Run with: cargo test --package civitas-accessibility test_live_uia_thread_lifecycle -- --nocapture --ignored
    #[test]
    #[ignore]
    ...
    /// Run with: cargo test --package civitas-accessibility test_live_cpu_usage -- --nocapture --ignored
    #[test]
    #[ignore]
    ...
    /// Run with: cargo test --package civitas-accessibility test_live_capture_quality -- --nocapture --ignored
    #[test]
    #[ignore]
