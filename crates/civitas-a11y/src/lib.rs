...
//! civitas-a11y: Cross-platform UI event capture for civitas
//!
//! This crate provides keyboard, mouse, and accessibility-based UI event capture
//! as a third modality for civitas, complementing vision (OCR) and audio.
//!
//! ## Features
//!
...
//!
//! ```rust,no_run
//! use civitas_a11y::{UiRecorder, UiCaptureConfig};
//!
