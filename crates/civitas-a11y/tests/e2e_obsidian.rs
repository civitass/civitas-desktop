...
//!
//! See https://github.com/civitass/civitas-desktop/issues/3002 — captured frames
...
//!
//! ```sh
//! cargo test -p civitas-a11y --test e2e_obsidian -- --test-threads=1 --nocapture --ignored
//! ```
//!
...
#[cfg(target_os = "macos")]
mod obsidian {
    use civitas_a11y::tree::{create_tree_walker, TreeWalkResult, TreeWalkerConfig};
    use std::path::Path;
    ...
    fn walker() -> Box<dyn civitas_a11y::tree::TreeWalkerPlatform> {
    ...
    fn measure(walker: &dyn civitas_a11y::tree::TreeWalkerPlatform) -> (usize, usize) {
