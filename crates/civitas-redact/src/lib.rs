...
//! Async PII redaction reconciliation for civitas.
//!
//! ## Why this crate exists
//!
//! Civitas captures OCR text, accessibility-tree text, audio
...
//! polling interval.
//!
//! See [issue #3185](https://github.com/civitass/civitas-desktop/issues/3185)
//! for the full design.
//!
//! ## Layout
//!
