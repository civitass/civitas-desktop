...
//!
//! Run with: cargo test -p civitas-screen --test empty_window_name_test -- --nocapture
...
fn test_production_scenario_multiple_apps() {
    ...
    let windows = vec![
        ...
        ("Arc", "GitHub - civitas"),   // Arc tab
        ("WezTerm", ""),               // Terminal internal? (empty)
        ("WezTerm", "~/code/civitas"), // Terminal window
