...
//!
//! Run with: cargo test -p civitas-screen --test url_timing_test -- --nocapture

use civitas_screen::browser_utils::{strip_title_badge, titles_match};
    ...
    fn new() -> Self {
        Self {
            tabs: vec![
                ...
                ("GitHub - civitas", "https://github.com/civitas"),
...
async fn test_title_mismatch_rejects_cross_domain() {
    // Real cases from civitas data where URL was wrong
