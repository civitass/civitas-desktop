...
//!
//! Run with: cargo test -p civitas-screen --test frame_window_mismatch_test -- --nocapture
    ...
    let capture1 = CaptureResult {
        ...
        windows: vec![
            ...
            WindowResult {
                ...
                window_name: "GitHub - civitas".to_string(),
                ocr_text: "civitas repository README".to_string(),
            },
        ],
    };
