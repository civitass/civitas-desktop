...
/// Coupling these means civitas captures exactly the pixels it stores —
...
mod tests {
    ...
    /// (user's civitas at 13.2 GB RSS after ~48 h).
    ///
    ...
    /// test — run with:
    ///   cargo test -p civitas-screen --lib monitor::tests::repro_list_monitors_autorelease_leak -- --ignored --nocapture
    #[cfg(target_os = "macos")]
