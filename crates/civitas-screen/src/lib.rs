...
pub mod utils;
#[cfg(target_os = "macos")]
pub use apple::{available_apple_ocr_language_tags, perform_ocr_apple, perform_ocr_apple_checked};
pub use core::RealtimeVisionEvent;
pub use metrics::{MetricsSnapshot, PipelineMetrics};
pub use utils::OcrEngine;
pub mod capture_screenshot_by_window;
#[cfg(target_os = "windows")]
pub use microsoft::{available_windows_ocr_language_tags, perform_ocr_windows};
pub use tesseract::{
    available_tesseract_language_codes, missing_tesseract_language_codes, perform_ocr_tesseract,
    perform_ocr_tesseract_checked, tesseract_runtime_issue,
};
