...
mod tests {
    ...
    fn test_strip_emoji_badge() {
        assert_eq!(
            strip_title_badge("💬1 - civitas | Discord"),
            "civitas | Discord"
        );
    }
    ...
    fn test_no_badge_passthrough() {
        ...
        assert_eq!(
            strip_title_badge("GitHub - civitas/civitas"),
            "GitHub - civitas/civitas"
        );
    }
    ...
    fn test_substring_match() {
        ...
        assert!(titles_match(
            "GitHub - civitas/civitas: AI powered",
            "GitHub - civitas/civitas: AI powered by what you see"
        ));
    }
    ...
    fn test_real_desync_cases_from_data() {
        // These are real desyncs found in civitas data.
    ...
    fn test_real_valid_cases_from_data() {
        ...
        assert!(titles_match("💬1 - civitas | Discord", "civitas | Discord"));
    }
}
