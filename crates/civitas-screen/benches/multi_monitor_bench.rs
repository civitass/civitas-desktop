...
//!
//! Run with: cargo bench -p civitas-screen --bench multi_monitor_bench
//!
...
use civitas_screen::frame_comparison::{compare_histogram, FrameComparer, FrameComparisonConfig};
