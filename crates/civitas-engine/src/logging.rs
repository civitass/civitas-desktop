...
//!
//! e.g. `civitas.2026-02-17.0.log`, `civitas.2026-02-17.1.log`
//!
//! # Example
//!
//! ```no_run
//! use civitas_engine::logging::SizedRollingWriter;
//!
...
mod tests {
    ...
    #[test]
    fn filename_format() {
        let name = SizedRollingWriter::filename("civitas", "log", "2026-02-17", 3);
        assert_eq!(name, "civitas.2026-02-17.3.log");
    }
