...
fn next_best_query(
    ...
    match data_status {
        ...
        "not_recording" => Some(
            "no local civitas captures exist yet. check /health or start recording before concluding the user was inactive.".to_string(),
        ),
...
mod db_tests {
    ...
    /// Real civitas timestamps are RFC3339 with microseconds and a `+00:00`
