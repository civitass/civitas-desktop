    ...
    match command {
        McpCommand::Setup {
            ...
            let run_command = format!(
                "uv --directory {} run civitas-mcp --port {}",
            ...
            if should_download {
                ...
                let repo = "civitas";
                let branch = "main";
                let target_dir = "packages/civitas-mcp";
...
async fn download_mcp_directory(
    ...
    headers.insert(USER_AGENT, HeaderValue::from_static("civitas-cli"));
        ...
        match item.content_type.as_str() {
            ...
            "dir" => {
                ...
                let subdir_api_url = format!(
                    "https://api.github.com/repos/{}/{}/contents/{}?ref={}",
                    "civitas", "civitas", item.path, "main"
                );
