...
fn monitor_for_point(
    monitors: &[civitas_screen::monitor::SafeMonitor],
    x: f64,
    y: f64,
...
impl Inner {
    ...
    fn resolve_and_emit(&self, monitors: &[civitas_screen::monitor::SafeMonitor]) {
...
impl DarwinFocusTracker {
    pub fn start() -> Result<Self> {
        ...
        std::thread::Builder::new()
            .name("civitas-focus-tracker".into())
            .spawn(move || {
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        let activate_cb = move |_note: &ns::Notification| {
            ...
            cidre::objc::ar_pool(|| {
                ...
                // by it.
                let monitors =
                    futures::executor::block_on(civitas_screen::monitor::list_monitors());
