...
use civitas_events::PermissionKind;
use civitas_screen::monitor::{list_monitors_detailed, MonitorListError};
...
pub async fn start_monitor_watcher(
    ...
    audio_manager: Option<civitas_audio::audio_manager::AudioManager>,
) -> anyhow::Result<()> {
