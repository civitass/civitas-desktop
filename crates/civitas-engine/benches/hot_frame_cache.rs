...
//!
//! Run with:
//!   cargo bench -p civitas-engine --bench hot_frame_cache

use chrono::{Duration, Utc};
use civitas_engine::hot_frame_cache::{HotAudio, HotFrame, HotFrameCache};
...
fn make_frame(id: i64) -> HotFrame {
    HotFrame {
        ...
        window_name: "civitas — Memory Optimization - Google Chrome".into(),
        ocr_text_preview: "The quick brown fox jumps over the lazy dog. "
            .repeat(4)
            .into(),
        snapshot_path: format!(
            "/Users/user/Library/Application Support/civitas/data/monitor_0_{}.jpg",
            id
        )
        .into(),
        browser_url: Some("https://github.com/mediar-ai/civitas".into()),
...
fn make_audio(id: i64, frame_ts: chrono::DateTime<Utc>) -> HotAudio {
    HotAudio {
        ...
        transcription: "Hello, this is a sample transcription for benchmarking purposes. It represents real-world audio captured by civitas.".into(),
        device_name: "MacBook Pro Microphone".into(),
        is_input: true,
        audio_file_path: format!("/Users/user/Library/Application Support/civitas/data/input_{}.mp4", id).into(),
        duration_secs: 30.0,
        start_time: Some(0.0),
        end_time: Some(30.0),
        speaker_id: Some(1),
