...
//!
//! Run with:
//!   cargo bench -p civitas-engine --bench alloc_counter

use chrono::Utc;
use civitas_engine::hot_frame_cache::{HotAudio, HotFrame};
...
fn bench_hotaudio_clone_allocs(c: &mut Criterion) {
    let audio = HotAudio {
        ...
        is_input: true,
        audio_file_path: "/Users/user/Library/Application Support/civitas/data/input_1.mp4".into(),
        duration_secs: 30.0,
        start_time: Some(0.0),
        end_time: Some(30.0),
        speaker_id: Some(1),
