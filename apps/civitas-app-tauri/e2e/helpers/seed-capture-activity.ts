...
/**
 * Bring a tiny non-Civitas window to the foreground briefly.
 *
 * Timeline streaming filters out OCR entries whose app name contains "civitas"
 * (see create_time_series_frame in civitas-engine). Captures that only see the
 * Civitas UI therefore produce no WebSocket frames and the timeline slider
