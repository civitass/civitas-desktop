  ...
  return (
    <div
      ...
      className={cn(
        ...
        // 200ms transition fights the pointer.
        isResizing ? "" : "transition-[width] duration-200 ease-out motion-reduce:transition-none",
        fullscreen ? "pt-2" : "pt-8",
        // Sidebar fill is ALWAYS the solid chat background (warm cream) so the
        // sidebar and chat read as one continuous warm surface — no frosted-glass
        // seam. We still apply the vibrant-* foreground/border treatments in
        // translucent mode for text/icon styling, but never the glass fill.
        "bg-background",
