...
export function TranscriptPanel({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "mb-3 flex flex-col border border-border bg-background transition-ui duration-200 ease-out",
          !isOpen && "hidden",
          isOpen &&
            (compactEmptyState
      ...
      >
        ...
        {showRecoveryBanner && (
          <div className="flex items-start gap-2 border-b border-warning/20 bg-warning/10 px-4 py-2 text-xs text-warning">
    ...
    >
      <div className="flex items-baseline gap-2 mb-1">
        {block.firstAudioFilePath ? (
          ...
          >
            <span
              className="inline-flex items-center gap-1 text-xs font-medium tracking-tight text-foreground/80 hover:text-foreground hover:underline underline-offset-2 cursor-pointer"
              title={
          ...
          <span className="inline-flex items-center gap-1 text-xs font-medium tracking-tight text-foreground/80">
            <User className="h-3 w-3 text-muted-foreground/70 self-center" />
            {block.speakerName}
          </span>
        )}
