            ...
            <div className="mt-3 flex flex-wrap gap-1.5">
              {providerOptions.map((provider) => (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 border border-border bg-background px-2 py-1 text-2xs text-muted-foreground transition-colors hover:border-foreground hover:text-foreground"
                >
                  <CalendarProviderIcon
  ...
  return (
    <div className="grid grid-cols-[64px_1fr] gap-5">
      <div className="pt-1">
        ...
        {rel && (
          <div className="text-2xs text-foreground/80 mt-2">
            {rel}
          </div>
        )}
      </div>
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 min-w-0">
            ...
            {isImminent && (
              <span className="shrink-0 text-2xs text-foreground border border-border px-1 py-px">
