...
export function ReplayStrip({ meetingId, segments, timeRange }: ReplayStripProps) {
  ...
  const openInTimeline = useCallback(async () => {
    ...
    try {
      ...
      console.warn("Meeting replay could not be opened in the timeline.");
    }
      ...
      <div className="border border-border bg-muted/10">
        ...
        <div className="aspect-video bg-background flex items-center justify-center overflow-hidden border-b border-border">
          {framesLoading ? (
            ...
            <span className="text-xs text-muted-foreground p-6">
        ...
        <div className="px-3 py-2 border-b border-border h-[96px] flex items-start gap-3 overflow-hidden">
          <span className="text-xs text-muted-foreground tabular-nums w-14 shrink-0 mt-0.5">
          ...
          <div className="flex-1 min-w-0 overflow-hidden">
            {showSpeakerPopover ? (
              ...
              >
                <button
                  className="text-xs text-muted-foreground hover:text-foreground underline decoration-dotted underline-offset-2 mr-1.5 transition-colors"
        ...
        <div className="px-3 py-1.5 flex items-center justify-between text-2xs text-muted-foreground tabular-nums">
