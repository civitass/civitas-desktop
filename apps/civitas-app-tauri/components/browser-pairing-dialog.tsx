    ...
    <Dialog open={Boolean(pending)}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            {pending
              ? `${labelBrowser(pending.browser)} wants to connect to Civitas. This lets agents use your open tabs when browser context is needed.`
              : "A browser wants to connect to Civitas."}
          </DialogDescription>
        </DialogHeader>
