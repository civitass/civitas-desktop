...
// and the civitas-pipe-creator SKILL.md
const PIPE_CONTEXT = `create a civitas pipe that does the following.

## what is a pipe?

a pipe is a scheduled AI agent defined as a single markdown file: ~/.civitas/pipes/{name}/pipe.md
every N minutes, civitas runs a coding agent (like pi or claude-code) with the pipe's prompt.
...
export function SchedulePromptDialog({
  ...
  const handleCreate = () => {
    ...
    const userRequest = [
      ...
      ``,
      `The pipe should run this prompt against my civitas data:`,
      ``,
    ...
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="sm:max-w-[440px]">
        ...
        <div className="space-y-4 mt-2">
          ...
          <div>
            ...
            <Input
              ...
              placeholder="Example: daily-recap, standup-notes"
            ...
            <div className="space-y-1">
              ...
              {showCustom && (
                <Input
                  ...
                  placeholder="Example: 0 */2 * * * (every 2 hours)"
        ...
        <div className="flex items-center justify-end gap-2 mt-4 pt-3 border-t border-border/30">
          ...
          <Button size="sm" onClick={handleCreate} className="h-8 text-xs gap-1.5">
