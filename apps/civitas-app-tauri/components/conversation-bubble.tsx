...
export function ConversationBubble({
	...
	return (
		...
		>
			...
			<div
				className={cn(
					"max-w-[85%] border border-border bg-background transition-ui rounded-[var(--radius)]",
					"border-l-2",
			...
			>
				...
				{isFirstInGroup && (
					<div className="flex items-center gap-2 px-3 pt-2 pb-1 border-b border-border">
						...
						<span className="text-2xs px-1.5 py-0.5 rounded bg-muted/40 text-muted-foreground inline-flex items-center gap-1">
							{isInput ? (
								<>
				...
				{!isFirstInGroup && (
					<div className="px-3 pt-1.5">
						<SpeakerAssignPopover
							...
							onAssigned={onSpeakerAssigned}
						>
							<span className="text-2xs text-muted-foreground hover:text-foreground cursor-pointer transition-colors duration-150">
				...
				<div className="px-3 pb-2 pt-2">
					...
					{/* Audio player */}
					{isPlaying && (
						<div className="mt-2 overflow-hidden border border-border rounded-md">
	...
	return (
		<div className="px-3 py-2 border-b border-border">
			<div className="flex items-center justify-between text-xs gap-2">
					...
					{visible.map((p) => {
						...
						return (
							<div
								key={p.id}
								className={cn(
									"flex items-center gap-1 px-1.5 py-0.5 rounded-r bg-muted/40 border-l-2",
									colorClass,
								)}
							>
				...
				<div className="text-muted-foreground text-2xs shrink-0">
