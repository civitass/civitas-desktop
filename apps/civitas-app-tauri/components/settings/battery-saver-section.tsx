  ...
  return (
    <div className="space-y-4">
      ...
      {profileInfo && ProfileIcon && (
        <div className="flex items-center gap-2 px-3 py-2 border border-border bg-card rounded-[var(--radius)] text-xs">
      ...
      <div className="grid grid-cols-3 gap-2">
        {modes.map((mode) => (
          <button
            ...
            disabled={updating}
            className={cn(
              "flex flex-col items-start p-3 border rounded text-left transition-ui duration-150",
      ...
      {state && (state.thermal_state === "serious" || state.thermal_state === "critical") && (
        <div className="flex items-center gap-2 px-3 py-2 border border-border bg-card rounded-[var(--radius)] text-xs text-muted-foreground">
          <span>
