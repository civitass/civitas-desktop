      ...
      <CardContent className="p-0">
        <div className="flex items-start p-4 gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              ...
              {allGranted && (
                <span className="px-2 py-0.5 text-xs font-medium bg-success-muted text-success rounded-full">
                  all enabled
                </span>
              )}
            </div>
            ...
            <p className="text-xs text-muted-foreground mb-3 leading-relaxed">
              civitas needs Automation permission to capture URLs from
                ...
                <div className="space-y-1.5">
                  {browsers.map((b) => (
                    ...
                    >
                      ...
                      {b.status === "granted" ? (
                        <span className="text-2xs text-success">Enabled</span>
                      ) : b.status === "denied" ? (
                        <Button
                          variant="ghost"
                          size="sm"
        ...
        <div className="px-4 py-2 bg-muted/50 border-t border-border">
          <p className="text-xs text-muted-foreground">
            ...
            Privacy &amp; Security → Automation → civitas
          </p>
        </div>
      </CardContent>
    </Card>
