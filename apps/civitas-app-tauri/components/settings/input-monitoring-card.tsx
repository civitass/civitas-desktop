  ...
  return (
    <div className="space-y-3">
      <p className="text-xs text-muted-foreground leading-relaxed">
        Lets civitas capture keystrokes and mouse clicks. Optional —
      ...
      <p className="text-xs text-muted-foreground">
        If the prompt doesn&apos;t appear, toggle <strong>Civitas</strong> on
        in System Settings → Privacy &amp; Security → Input Monitoring. Relaunch
        civitas after enabling — macOS only applies TCC changes on next
        process start.
      </p>
      ...
      {suspectedGhost && !granted ? (
        <div className="rounded-md border border-destructive/30 bg-destructive/5 px-3 py-2">
          <p className="text-xs text-destructive">
            ...
            <strong> Civitas </strong> on in System Settings → Privacy &amp;
      ...
      {grantedThisSession ? (
        <div className="rounded-md border border-warning/30 bg-warning/5 px-3 py-2">
          <p className="text-xs text-warning">
            <strong>Restart civitas</strong> to start capturing keystrokes
