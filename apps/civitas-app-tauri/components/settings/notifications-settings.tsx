    ...
    <div className="space-y-6">
      <div>
        <p className="text-muted-foreground text-sm">
          Control which notifications Civitas sends you.
        </p>
      </div>
      ...
      <div className="space-y-1">
        ...
        <div className="flex items-center justify-between py-3 border-b border-border">
          <div>
            <p className="text-sm font-medium">Capture stalls <span className="text-2xs font-normal text-muted-foreground/70 ml-1">Experimental</span></p>
