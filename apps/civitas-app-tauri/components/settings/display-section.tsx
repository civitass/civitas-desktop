...
import { Moon, Sun, Monitor, Layers, MessageSquare, PanelLeft, EyeOff, MinusSquare, Type } from "lucide-react";
...
export function DisplaySection() {
  ...
  // re-render) so we never fire two overlapping civitas restarts.
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-2">
                ...
                {FONT_SIZE_OPTIONS.map((option) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex-1 px-2.5 py-1.5 border-2 transition-ui text-center cursor-pointer ${
                        isActive
        ...
        {/* Disable Timeline / rewind. Gates timeline-only backend work
            ...
            unlike the other display toggles it needs a full civitas restart
              ...
              <Switch
                ...
                onCheckedChange={async (checked) => {
                  ...
                  try {
                    ...
                    // it needs a full civitas restart to take effect.
                    try {
                      ...
                      toast({
                        ...
                        description: "Civitas restarted to apply the change.",
                      });
                    } catch (e) {
                      toast({
                        title: "Failed to restart Civitas",
                        description: "Restart Civitas manually to apply the change.",
                        variant: "destructive",
                      });
                    }
                  } finally {
                ...
                {([
                  ...
                  return (
                    <button
                      ...
                      type="button"
                      className={`flex-1 px-2.5 py-1.5 rounded-md border-2 transition-ui text-left cursor-pointer ${
                        isActive
                          ? "border-primary bg-primary/5"
                          : "border-border hover:border-muted-foreground/30"
                      }`}
              ...
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  <h3 className="text-sm font-medium text-foreground flex items-center gap-1.5">
                    ...
                    <HelpTooltip text="When enabled, the civitas overlay will be visible in screen recordings and screenshots made by other apps like OBS or Screen Studio." />
                  </h3>
                ...
                <div className="flex items-center space-x-2.5">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-foreground flex items-center gap-1.5">
                      ...
                      <HelpTooltip text="When enabled, clicking the X on the Home window hides it and removes it from the Windows taskbar. civitas keeps running in the system tray — click the tray icon to bring the window back." />
                    </h3>
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => {
                    ...
                    toast({
                      ...
                      description: checked
                        ? "Click the tray icon to bring civitas back."
                        : undefined,
                    });
                  }}
                />
