...
const CIVITAS_FONT_FAMILY = '-apple-system, BlinkMacSystemFont, "SF Pro Text", "Helvetica Neue", Arial, sans-serif';

// Civitas brand theme — outlined minimalist (DESIGN.md):
...
const CIVITAS_THEME = {
  ...
  themeVariables: {
    ...
    fontFamily: CIVITAS_FONT_FAMILY,
    fontSize: "14px",
    nodeBorder: "#000000",
    clusterBkg: "#f5f5f5",
  ...
  useEffect(() => {
    const renderDiagram = async () => {
      ...
      try {
        ...
        const theme = isDark ? CIVITAS_THEME_DARK : CIVITAS_THEME;
        ...
        console.error("Diagram could not be rendered.");
