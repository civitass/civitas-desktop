 ...
 *
 * Measures URL-detection accuracy against a deliberately synthetic fixture.
 * Reserved example domains keep this public regression test reproducible and
 * ensure that no captured screen content or personal identifier is committed.
 *
 * Metrics:
...
describe("URL Detection Benchmark", () => {
	it("should report dataset statistics", () => {
		...
		expect(data.metadata.synthetic_fixture).toBe(true);
