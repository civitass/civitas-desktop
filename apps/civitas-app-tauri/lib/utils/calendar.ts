...
// Native OS Calendar wraps events in {data: [...]}. Native and ICS providers
// can be connected at once; both are read-only and merged locally.
...
/**
 * Fetch upcoming calendar events from any connected provider (native OS
 * Calendar and/or ICS). Returns null when no calendar is
