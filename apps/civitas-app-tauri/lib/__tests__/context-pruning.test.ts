 ...
 * (crates/civitas-core/assets/extensions/context-pruning.ts).
 *
 ...
 * SHIPPED extension file (via the @civitas-ext alias) and drive the actual
...
} from "@civitas-ext/context-pruning";
