...
describe("source citations", () => {
  ...
  it("derives a civitas search citation from bash curl calls", () => {
    const citations = sourceCitationsFromMessage({
      contentBlocks: [
        {
          type: "tool",
    ...
    expect(citations[0].kind).toBe("civitas");
    expect(citations[0].title).toBe("Civitas search");
    expect(citations[0].subtitle).toContain("audio");
    expect(citations[0].subtitle).toContain("query: pricing");
  });

  it("names connector calls instead of collapsing them to generic civitas api", () => {
    const citations = sourceCitationsFromMessage({
      contentBlocks: [
        {
          type: "tool",
  ...
  it("labels civitas memory endpoint citations as memory", () => {
    const citations = sourceCitationsFromMessage({
      contentBlocks: [
        {
          type: "tool",
  ...
  it("pulls structured result links out of bash tool output", () => {
          ...
          toolCall: {
            ...
            result: JSON.stringify({
              search_results: [
                {
                  title: "Civitas docs",
                  url: "https://docs.civitas.team/chat",
                },
              ],
            }),
            isRunning: false,
    ...
    expect(citations[1]).toMatchObject({
      kind: "web",
      title: "Civitas docs",
      href: "https://docs.civitas.team/chat",
    });
  });
      ...
      contentBlocks: [
        {
          ...
          toolCall: {
            toolName: "read",
            args: { path: "/Users/example/.codex/memories/MEMORY.md" },
            result: "notes",
            isRunning: false,
          },
        },
        {
          ...
          toolCall: {
            toolName: "read",
            args: {
              path: "/tmp/civitas-source-citations/apps/civitas-app-tauri/components/standalone-chat.tsx",
            },
            result: "code",
            isRunning: false,
          },
      ...
      contentBlocks: [
        {
          ...
          toolCall: {
            ...
            args: { path: "/Users/example/.civitas/pipes/lead-radar/pipe.ts" },
            result: "code",
            isRunning: false,
          },
        },
      ...
      contentBlocks: [
        {
          ...
          toolCall: {
            ...
            args: {
              command:
                "sed -n '1,20p' apps/civitas-app-tauri/components/standalone-chat.tsx",
            },
            result: "code",
            isRunning: false,
          },
      ...
      contentBlocks: [
        {
          ...
          toolCall: {
            toolName: "web_search",
            args: { query: "civitas docs" },
            result:
              "Sources:\n- [Docs](https://docs.civitas.team/chat)\n- https://docs.civitas.team/chat",
            isRunning: false,
          },
        },
      ],
      ...
      contentBlocks: [
        {
          ...
          toolCall: {
            ...
            result: {
              ...
              details: {
                sources: [
                  { title: "Docs", url: "https://docs.civitas.team/chat" },
                  { title: "Duplicate", url: "https://docs.civitas.team/chat" },
                ],
              },
            },
            isRunning: false,
  ...
  it("derives direct civitas_search tool citations", () => {
    const citations = sourceCitationsFromMessage({
      contentBlocks: [
        {
          type: "tool",
          toolCall: {
            toolName: "civitas_search",
            args: {
              content_type: "ocr",
              app_name: "Slack",
              query: "roadmap",
  ...
  it("anchors civitas_search tool citations to the capture moment", () => {
    const citations = sourceCitationsFromMessage({
      contentBlocks: [
        {
          type: "tool",
  ...
  it("anchors bash civitas /search citations to the url-encoded start_time", () => {
    const citations = sourceCitationsFromMessage({
      contentBlocks: [
        {
          type: "tool",
      ...
      contentBlocks: [
        {
          ...
          toolCall: {
            ...
            args: {
              command:
                'curl -s "http://localhost:3030/memories?q=pricing&limit=5"',
            },
            result: '{"data":[]}',
            isRunning: false,
          },
  ...
  it("leaves civitas_search citations without a start_time unanchored", () => {
    const citations = sourceCitationsFromMessage({
      contentBlocks: [
        {
          type: "tool",
      ...
      contentBlocks: [
        {
          ...
          toolCall: {
            ...
            args: {
              command:
                'curl -s "http://localhost:3030/search?content_type=ocr&q=pricing%20deck"',
            },
            result: '{"data":[]}',
            isRunning: false,
          },
      ...
      contentBlocks: [
        {
          ...
          toolCall: {
            ...
            args: {
              command:
                'curl -s "http://localhost:3030/activity-summary?start_time=2026-05-15T17:00:00Z"',
            },
            result: '{"data":[]}',
            isRunning: false,
          },
      ...
      contentBlocks: [
        {
          ...
          toolCall: {
            toolName: "read",
            args: { path: "/Users/me/.civitas/pipes/sync/state.json" },
            result: "{}",
            isRunning: false,
          },
        },
  ...
  describe("computeChatCitationPlan", () => {
    ...
    it("scopes aggregation per turn so separate user questions stay separate", () => {
      ...
      expect(plan.aggregatedAfter.get("a2")?.map((c) => c.title)).toEqual([
        "Read: a.ts",
      ]);
      expect(plan.aggregatedAfter.get("b2")?.map((c) => c.title)).toEqual([
        "Read: b.ts",
      ]);
    });
    ...
    const markdown = formatSourceCitationsMarkdown([
      {
        ...
        title: "Docs",
        subtitle: "web search",
        href: "https://docs.civitas.team/",
      },
    ]);

    expect(markdown).toContain("**Source:**");
    expect(markdown).toContain("[Docs](https://docs.civitas.team/)");
