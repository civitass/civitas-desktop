...
const systemFontStack = ["-apple-system", "BlinkMacSystemFont", "SF Pro Text", "Helvetica Neue", "Arial", "sans-serif"];
  ...
  theme: {
	container: {
	  ...
	  extend: {
		...
		fontSize: {
		  // Unitless line-heights so leading tracks --font-size-base at every
		  // Display setting (the old fixed-rem leading drifted: tight at large
		  // sizes, loose at small). Body tiers breathe; display tiers tighten.
