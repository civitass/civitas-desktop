...
//! in-process. This is the headless `civitas export` CLI's in-app twin:
...
pub async fn export_recording(
    ...
    let db = {
        ...
        let core = guard
            .as_ref()
            .ok_or("recording isn't running yet — start civitas, then export")?;
        core.db.clone()
    };
